...
pub fn get_oidc_url(
    ...
    Ok(match provider {
            ...
            OIDCProvider::TestEveFrontier => format!("https://test.auth.evefrontier.com/oauth2/authorize?client_id={}&response_type=id_token&scope=openid&redirect_uri={}&nonce={}", client_id, redirect_url, nonce),
