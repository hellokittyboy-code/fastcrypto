...
pub fn get_oidc_url(
    ...
    Ok(match provider {
            ...
            OIDCProvider::BenPay => format!("https://accounts.google.com/o/oauth2/v2/auth?client_id={}&response_type=id_token&redirect_uri={}&scope=openid&nonce={}", client_id, redirect_url, nonce),
