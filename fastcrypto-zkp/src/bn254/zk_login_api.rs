...
fn insecure_pvk() -> PreparedVerifyingKey<Bn254> {
    ...
    let vk_delta_2 = g2_affine_from_str_projective(&vec![
        vec![
            Bn254FqElement::from_str(
                "2911985344566092556637386908107902557732572849933677439222460657527814419293",
            )
            .unwrap(),
            Bn254FqElement::from_str(
                "5632260013624652387152181042823114443028417816743736451816335089757248870129",
            )
            .unwrap(),
        ],
        vec![
            Bn254FqElement::from_str(
                "4137600534329111988032230292868712288067369977122203368648643806761017002600",
            )
            .unwrap(),
            Bn254FqElement::from_str(
                "4515579078743288301274933163625346943762584530827910055816171475776372715636",
            )
            .unwrap(),
        ],
        vec![
    ...
    for e in [
        vec![
            Bn254FqElement::from_str(
                "19444714626980980084592149264241127942885167811163917026782961121596562361404",
            )
            .unwrap(),
            Bn254FqElement::from_str(
                "6367765063052720388687491961156238056597882478237387865183979623320427140282",
            )
            .unwrap(),
            Bn254FqElement::from_str("1").unwrap(),
        ],
        vec![
            Bn254FqElement::from_str(
                "20110719722140021163268175466917427787020105780091240341692093917901985506444",
            )
            .unwrap(),
            Bn254FqElement::from_str(
                "6410412626632579284009616915771362127197333669399764378474892958987735451868",
            )
            .unwrap(),
            Bn254FqElement::from_str("1").unwrap(),
        ],
